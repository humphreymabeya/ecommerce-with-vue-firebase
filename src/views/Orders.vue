<template>
  <div class="products">
      <div class="container h-100">
        ...
        <button @click="addNew()" class="btn btn-primary float-right"><i class="fa fa-plus"> Add Product</i></button><hr>
          ...
          <table class="table">
            ...
            <tbody>
              <tr v-for="product in products">
                ...
                <td>
                  <button class="btn btn-primary" @click="editProduct(product)">Edit</button>  <button class="btn btn-danger" @click="deleteProduct(product)">Delete</button>
                </td>
              </tr>
            </tbody>
          </table>
